      ...
      <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center mb-3 sm:mb-4">
            {isOpen && (
              <div
                ...
                className="flex items-center gap-2 hover:cursor-pointer sm:gap-3"
              >
            ...
            {!isOpen && (
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-[#E31B54] to-[#E91E63] rounded-xl flex items-center justify-center p-2 mx-auto">
                <img
                  ...
                  alt="TaskIT"
                  className="w-full hover:cursor-pointer h-full object-contain brightness-0 invert"
                />
              </div>
            )}
          </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                } py-2.5 sm:py-3 rounded-xl transition-all group relative ${
                  active
        ...
        <div className="p-3 sm:p-4 border-t border-gray-200 space-y-2">
          <button
            ...
            className={`w-full flex items-center ${
              isOpen ? "gap-2 sm:gap-3 px-2 sm:px-3" : "justify-center"
            } py-2.5 sm:py-3 rounded-xl transition-all hover:bg-gray-50 text-black hover:scale-105
            ${
              isActive("/settings")
                ? "bg-gradient-to-br from-[#E31B54] to-[#E91E63]"
                : "hover:bg-gray-50 text-black hover:scale-105"
          ...
          >
            <div
              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center  text-black flex-shrink-0  `}
            >
              <Settings
                className={`w-4 h-4 sm:w-5 sm:h-5 ${
                  isActive("/settings") ? "text-white" : "text-black"
                }`}
              />
            </div>
            {isOpen && (
