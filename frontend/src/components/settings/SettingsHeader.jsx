  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#E31B54] to-[#E91E63] rounded-3xl p-8 shadow-xl">
      ...
      <div className="relative flex flex-col sm:flex-row items-center gap-6">
        ...
        <button className="px-6 py-3 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white font-semibold rounded-xl transition-all hover:scale-105 border border-white/30">
